...
export const blogPosts: BlogPost[] = [
  {
    slug: "best-restaurant-catering-operating-support-canada",
    title: "Restaurant Catering Operating Support in Canada: What to Look For",
    description: "How Canadian restaurants can evaluate catering operating support for large-order fulfillment, from ordering and kitchen workflows to delivery and growth.",
    date: "2026-08-21", readTime: "8 min read", category: "Operating support",
    intro: "The best restaurant catering operating support is not simply another ordering tool. It should help a restaurant accept larger orders confidently, translate every order into a reliable production plan, coordinate delivery, and learn from performance. Canadian operators should evaluate the complete workflow and the level of hands-on support behind it.",
    sections: [
    ...
    faqs: [
      ...
      { question: "What is the best catering operating support service in Canada?", answer: "There is no universal best platform. The right choice depends on restaurant format, current POS and ordering stack, catering volume, delivery model, Canadian availability, budget, and whether the operator needs software alone or hands-on growth and operating support." },
