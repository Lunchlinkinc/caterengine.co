...
export default async function LocationPage({ params }: { params: Promise<{ city: string }> }) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "Service", name: `Restaurant catering growth services in ${market.city}`, url: `https://www.caterengine.co/locations/${slug}`, provider: { "@type": "Organization", name: "CaterEngine", url: "https://www.caterengine.co" }, areaServed: { "@type": "City", name: market.city, containedInPlace: { "@type": "State", name: market.state } }, description: market.description };
