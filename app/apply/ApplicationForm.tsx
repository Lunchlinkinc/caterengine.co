...
export function ApplicationForm(){
 ...
 return <form className="real-form" onSubmit={submit}>
   ...
   <div className="form-row"><label>City<select required name="city" defaultValue=""><option value="" disabled>Select city</option><option>Houston</option><option>Austin</option><option>Dallas</option><option>Other</option></select></label><label>State<input required name="state" defaultValue="TX" /></label></div>
