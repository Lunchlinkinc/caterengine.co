...
export const metadata: Metadata = { title: "How Restaurant Catering Growth Works", description: "See how CaterEngine helps restaurant operators qualify the opportunity, design the catering offer, generate demand, and improve fulfillment.", alternates: { canonical: "/how-it-works" } };
